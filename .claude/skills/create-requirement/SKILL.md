---
description: File a new REQ-NNNN artifact under .catalyst-proj/requirements/ (alias of /create-req)
argument-hint: <description>
---

Alias of `/create-req` — identical behavior, see
`.claude/commands/create-req.md`. Per
`.catalyst-proj/CODE-OF-CONDUCT.md` §3 ("Slash-command
...
describe what you'd do, actually create the file.
...
2. Determine the `Targets`/source rule ID(s) this requirement captures or
   ...
   `.catalyst-proj/CODE-OF-CONDUCT.md` §1 — new rules
