...
contextBridge.exposeInMainWorld("cttc", {
  ...
  getDockerHosts: () => ipcRenderer.invoke("get-docker-hosts"),
  retireDockerHost: (hostIdOrKey) => ipcRenderer.invoke("retire-docker-host", hostIdOrKey),
  ...
  vaultSetup: (passphrase, confirm) => ipcRenderer.invoke("vault-setup", { passphrase, confirm }),
  vaultUnlock: (passphrase) => ipcRenderer.invoke("vault-unlock", { passphrase }),
  vaultCancel: () => ipcRenderer.invoke("vault-cancel"),
