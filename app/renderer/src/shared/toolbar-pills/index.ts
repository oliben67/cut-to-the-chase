...
// moment one of them opens its own -- see app.js's former ~L5867-5928.
// Each pill registers its own hasOverlay/closeOverlay; genuinely shared
// between the gateway and docker-host modules, not owned by either.
...
const pills: Record<string, ToolbarPill> = {};

export function registerToolbarPill(id: string, pill: ToolbarPill): void {
  pills[id] = pill;
}

export function syncPillPeerVisibility(actingId: string): void {
...
export const CLIPBOARD_ICON_SVG =
